...
export default function CoreMessageBank({ userName }: CoreMessageBankProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 mt-8">
      ...
      <p className="text-emerald-600 mb-6 text-center italic">
          ...
          >
            <div className="flex items-start mb-2">
              <div
                className={`w-6 h-6 rounded-full flex items-center justify-center mr-2 ${
                  selectedMessage === index ? "bg-emerald-500" : "bg-gray-300"
                }`}
              >
                {selectedMessage === index && (
                  <svg
            ...
            {isEditing ? (
              <textarea
                ...
                className="w-full h-40 p-2 text-sm border border-emerald-200 rounded 
               focus:ring-2 focus:ring-emerald-500 text-black bg-white"
              />
            ) : (
